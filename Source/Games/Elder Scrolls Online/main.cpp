...
#define GAME_ELDER_SCROLLS_ONLINE 1
...
struct GameDeviceDataElderScrollsOnline final : public GameDeviceData
{
   bool has_drawn_tonemap = false;
};

class ElderScrollsOnline final : public Game
{
   // Optional helper to hide ugly casts
   static GameDeviceDataElderScrollsOnline& GetGameDeviceData(DeviceData& device_data)
   {
      return *static_cast<GameDeviceDataElderScrollsOnline*>(device_data.game);
   }
...
public:
   ...
   {
      device_data.game = new GameDeviceDataElderScrollsOnline;
   }
   ...
   void PrintImGuiAbout() override
   {
      ...
      ImGui::Text("Elder Scrolls Online Luma mod - about and credits section", "");
   }
};
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved)
{
   if (ul_reason_for_call == DLL_PROCESS_ATTACH)
   {
      ...
      Globals::SetGlobals(cleared_project_name, "Elder Scrolls Online Luma mod", nullptr /*E.g. Nexus link*/, mod_version);
